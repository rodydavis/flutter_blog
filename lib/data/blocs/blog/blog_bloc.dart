...
import 'package:flutter_blog/r.dart';
...
class BlogBloc extends Bloc<BlogEvent, BlogState> {
  @override
  BlogState get initialState => PostsReady(_posts);
  ...
  List<FbPost> get _posts => <FbPost>[
        FbPost(
          author: _author,
          title: 'Launching… Space Curiosity!',
          description: 'New Flutter App',
          path: R.assetsPosts20190308AppLaunchSpaceCuriosity,
          image:
        ...
        FbPost(
          ...
          path: R.assetsPosts20190310ThePitchPipe,
          image:
        ...
        FbPost(
          ...
          path: R.assetsPosts20190311FlutterOneClickRelease,
          image:
        ...
        FbPost(
          ...
          path: R.assetsPosts20190312MakingAPiano,
          image:
        ...
        FbPost(
          ...
          path: R.assetsPosts20190315AutomateFlutterApps,
          image:
        ...
        FbPost(
          ...
          path: R.assetsPosts20190906OneCodebaseManyPlaces,
          image:
